...
export class UsuariosService {
  ...
  agregaUsuario(usuario: any): Observable<any>{
    return this.http.post<any>('http://localhost:3000/api/v1/users', usuario);
  }
  ...
  deleteUser(id:any): Observable<any>{
    return this.http.delete<any>(`http://localhost:3000/api/v1/users/${id}`);
  }
  ...
  editUser(id:any, user: any): Observable<any>{
    return this.http.patch<any>(`http://localhost:3000/api/v1/users/${id}`, user);
  }
